    ...
    <div className="menu-modal">
            ...
            >
              ...
              <div className="event-description">
                ...
                <p>
                  ...
                  skates and take a spin on the rink. It's the perfect opportunity to showcase your
                  skills. And who can resist the delectable goodness of s'mores? Make your own gooey
                  treats and relish the sweet taste of the season. It pairs perfectly with a warm
                  cup of hot chocolate. It's not truly the holiday season without a visit to Santa
        ...
        <section className="today">
          ...
          <div className="adventures">
            ...
            <div className="admission">
              <h3>Admission</h3>
              <p>
                For the best experience and the quickest entry, we encourage guests to buy tickets
                online. Tickets are also available for purchase at the ticket office upon arrival.
      ...
      <nav className="mobile-nav">
        <ul>
          ...
          <li className="specific-link">
            <a href="#">Zoo Lights</a>
          </li>
          <li className="specific-link">
            <a href="#">Breakfast With Santa</a>
          </li>
          <li className="general-link">
          ...
          <li className="general-link">
            <a href="#">Our Research Team</a>
          </li>
          <li className="general-link">
            <a href="#">Conservation Action Network</a>
          </li>
          <li className="general-link">
            <a href="#">Arboretum</a>
          </li>
          <li className="specific-link">
            <a href="#">Shade Garden</a>
          </li>
          <li className="general-link">
            <a href="#">Go Green</a>
          </li>
          ...
          <li className="general-link">
            <a href="#">Twilight Tours</a>
          </li>
          <li className="general-link">
            <a href="#">Virtual Zoo Programs</a>
          </li>
          <li className="general-link">
            <a href="#">Zoo Labs</a>
          </li>
          <li className="general-link">
            <a href="#">Owl Programs</a>
          </li>
          <li className="general-link">
            <a href="#">Zoo Snooze</a>
          </li>
          <li className="general-link">
            <a href="#">Zoo Strolls</a>
          </li>
          <li className="general-link">
            <a href="#">Zoo Camps</a>
          </li>
          <li className="general-link">
            <a href="#">Zoo Scouts Programs</a>
          </li>
